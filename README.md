...
```bash
sudo curl -L "https://github.com/sbneto/s3conf/releases/download/0.9.7/s3conf-$(uname -s)-$(uname -m)" -o /usr/local/bin/s3conf
...
```bash
sudo curl -L "https://github.com/sbneto/s3conf/releases/download/0.9.7/s3conf-$(uname -s)-$(uname -m)-alpine" -o /usr/local/bin/s3conf
sudo chmod 755 /usr/local/bin/s3conf
```
